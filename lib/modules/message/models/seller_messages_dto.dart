...
class SellerDto extends Equatable {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'shop_appwner_id': shopOwnerId,
      'shop_appwner': shopOwner,
      'shop_name': shopName,
      'shop_appr_vendor_id': shopVendorId,
      'shop_slug': shopSlug,
      'shop_logo': shopLogo,
  ...
  factory SellerDto.fromMap(Map<String, dynamic> map) {
    return SellerDto(
      shopOwnerId: map['shop_appwner_id'] != null
          ? int.parse(map['shop_appwner_id'].toString())
          : 0,
      shopOwner: map['shop_appwner'] as String,
      shopName: map['shop_name'] as String,
      shopVendorId: map['shop_appr_vendor_id'] != null
          ? int.parse(map['shop_appr_vendor_id'].toString())
          : 0,
