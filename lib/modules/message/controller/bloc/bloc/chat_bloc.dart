...
import 'package:shop_app/modules/message/models/seller_messages_dto.dart';
import 'package:shop_app/modules/message/models/send_message_response_dto.dart';
import 'package:shop_app/modules/product_details/model/product_details_model.dart';
import 'package:shop_app/state_packages_names.dart';
...
class ChatBloc extends Bloc<ChatEvent, ChatStateModel> {
  ...
  FutureOr<void> _loadChats(
    ...
    result.fold((failure) {
      final cState = ChatError(failure.message);
      emit(state.copyWith(state: cState));
    }, (success) {
      final cState = ChatLoaded(success);
